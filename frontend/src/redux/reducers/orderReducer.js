...
export const orderPayReducer = (state={},action) =>{
    switch (action.type) {
        ...
        case ORDER_PAY_SUCCESS: return {loading:false, order:action.payload}
...
export const listMyOrdersReducer = (state={orders:[]},action) =>{
    switch (action.type) {
        case LIST_MY_ORDERS_REQUEST: return {loading:true}
        case LIST_MY_ORDERS_SUCCESS: return {loading:false, orders:action.payload}
        case LIST_MY_ORDERS_FAIL   : return {loading:false, error:action.payload}
        case LIST_MY_ORDERS_RESET : return {orders:[]}
        default               : return state
    }
}
...
export const listOrdersReducer = (state={orders:[]},action) =>{
    switch (action.type) {
        case LIST_ORDERS_REQUEST: return {loading:true}
        case LIST_ORDERS_SUCCESS: return {loading:false, orders:action.payload}
        case LIST_ORDERS_FAIL   : return {loading:false, error:action.payload}
        default               : return state
    }
}
